            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="nav-tabs-custom no-shadow">
                        ...
                        <br>
                        <form action="{{ route('admin.banners.update', $banner->id) }}" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left">
                            @csrf
                            @method('patch')
                            <div class="tab-content">
                                <div id="tab_banner" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-11 col-sm-9 col-xs-12">
                                            <input type="text" name="position" id="position" class="form-control" value="{{ old('position', $banner->position) }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="width" class="control-label col-md-1 col-sm-3 col-xs-12">عرض</label>
                                        <div class="col-md-11 col-sm-9 col-xs-12">
                                            <input type="number" name="width" id="width" class="form-control" value="{{ old('width', $banner->width) }}" dir="ltr" min="1">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="height" class="control-label col-md-1 col-sm-3 col-xs-12">طول</label>
                                        <div class="col-md-11 col-sm-9 col-xs-12">
                                            <input type="number" name="height" id="height" class="form-control" value="{{ old('height', $banner->height) }}" dir="ltr" min="1">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-1 col-sm-3 col-xs-12">وضعیت</label>
                                        <div class="col-md-11 col-sm-9 col-xs-12">
                                            <input type="checkbox" name="status" id="status" value="1" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> انتشار" data-off="<i class='fa fa-close text-red'></i> پیش‌نویس"{{ old('status', $banner->status) ? ' checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
