            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="nav-tabs-custom no-shadow">
                        ...
                        <br>
                        <form action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" id="form">
                        @csrf
                            <div class="tab-content">
                                <div id="tab_general" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="slug" type="text" class="form-control" name="slug" value="{{ old('slug') }}" placeholder="Enter the product slug" dir="ltr" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="tab_information" class="tab-pane">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="special_mask" name="special_mask" class="form-control mask" value="{{ old('special_mask') }}" required>
                                            <input type="hidden" name="special" id="special" class="special" value="{{ old('special') }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="checkbox" name="status" id="status" value="1" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-cart-arrow-down'></i> انتشار" data-off="<i class='fa fa-cart-plus text-red'></i> پیش‌نویس"{{ old('status') ? ' checked' : '' }} data-width="120">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="category_id[]" id="categories" class="form-control" multiple="multiple">
                                            @foreach($categories as $key => $category)
                                                <option value="{{ $key }}"{{ (in_array($key, old('category_id', [])) ? ' selected' : '') }}>{{ $category }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div id="tab_attributes" class="tab-pane">
                                    ...
                                    <tbody>
                                    @foreach(old('attribute_id', []) as $k => $attr)
                                        <tr>
                                            <td>
