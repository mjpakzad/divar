            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="nav-tabs-custom no-shadow">
                        ...
                        <br>
                        <form action="{{ route('admin.groups.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left">
                        @csrf
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div id="gender" class="btn-group" data-toggle="buttons">
                                                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                    <input type="radio" name="status" value="0" data-parsley-multiple="status"{{ old('status') ? '' : ' checked' }}> پیش‌نویس
                                                </label>
                                                <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                    <input type="radio" name="status" value="1" data-parsley-multiple="status"{{ old('status') ? ' checked' : '' }}> انتشار
                                                </label>
                                            </div>
                                        </div>
                                    </div>
