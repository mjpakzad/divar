                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <a href="{{ route('admin.groups.index') }}">دسته‌بندی‌ها
                    ...
                    <div class="x_content">
                        <div class="nav-tabs-custom no-shadow">
                            ...
                            <br>
                            <form action="{{ route('admin.groups.update', $group->slug) }}" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left">
                                @csrf
                                @method('PATCH')
                                <div class="tab-content">
                                    <div id="tab_general" class="tab-pane active">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug', $group->slug) }}" dir="ltr">
                                            </div>
                                        </div>
                                    </div>
                                    <div id="tab_seo" class="tab-pane">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea name="meta_keywords" id="meta_keywords" class="form-control" rows="3" placeholder="کلمات کلیدی را با خط تیره (-) از هم جدا کنید">{{ old('meta_keywords', comma2dash($group->meta_keywords)) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="meta_description" class="control-label col-md-3 col-sm-3 col-xs-12">متا تگ توضیحات</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea name="meta_description" id="meta_description" class="form-control" rows="5">{{ old('meta_description', $group->meta_description) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select name="parent_id" id="parent_id" class="form-control" dir="rtl">
                                                    ...
                                                    @foreach($parents as $id => $name)
                                                        <option value="{{ $id }}"{{ (old('parent_id', $group->parent_id) == $id ? 'selected' : '') }}>{{ $name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div id="gender" class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                        <input type="radio" name="status" value="0" data-parsley-multiple="status"{{ (old('status', $group->status) == 0 ? ' checked' : '') }}> پیش‌نویس
                                                    </label>
                                                    <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                        <input type="radio" name="status" value="1" data-parsley-multiple="status"{{ (old('status', $group->status) == 1 ? ' checked' : '') }}> انتشار
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
