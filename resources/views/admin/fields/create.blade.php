            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="nav-tabs-custom no-shadow">
                        ...
                        <br>
                        <form action="{{ route('admin.fields.store') }}" method="post" data-parsley-validate="" class="form-horizontal form-label-left">
                        @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select id="buying" name="buying" class="form-control">
                                                <option value="2"{{ old('buyin') == 2 ? ' selected' : '' }}>مشترک</option>
                                                <option value="0"{{ old('buyin') == 0 ? ' selected' : '' }}>تحویل</option>
                                                <option value="1"{{ old('buyin') == 1 ? ' selected' : '' }}>دریافت</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="checkbox" class="toggle" name="is_price" id="is_price" value="1" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> فیلد قیمت" data-off="<i class='fa fa-close text-red'></i> فیلد معمولی" data-width="120">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="is_tag" class="control-label col-md-3 col-sm-3 col-xs-12">فیلد برچسب</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="checkbox" class="toggle" name="is_tag" id="is_tag" value="1" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> بله" data-off="<i class='fa fa-close text-red'></i> خیر" data-width="120">
                                        </div>
                                    </div>
                                </div>
