            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="nav-tabs-custom no-shadow">
                        ...
                        <br>
                        <form action="{{ route('admin.categories.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left">
                        @csrf
                            <div class="tab-content">
                                ...
                                <div id="tab_information" class="tab-pane">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="buy" id="buy" class="form-control" value="{{ old('buy') }}" placeholder="تقاضا">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="sell" class="control-label col-md-3 col-sm-3 col-xs-12">برچسب فروش</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="sell" id="sell" class="form-control" value="{{ old('sell') }}" placeholder="عرضه">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select name="fields[]" id="fields" class="form-control" multiple="multiple" dir="rtl">
                                                @foreach($fields as $field)
                                                    <option value="{{ $field->id }}"{{ (in_array($field->id, old('fields') ?? []) ? 'selected' : '') }}>{{ $field->name_label }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
